...
@section('content')
                ...
                <div class="modal-body">
                    ...
                    <form id="formAdAdd" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success" id="addAd">{{ __('Save') }}</button>
    ...
    <!-- End Basic modal -->
    <div class="modal" id="modalAdUpdate">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <form id="formAdUpdate" enctype="multipart/form-data">
                        @method('PUT')
    ...
    <div class="modal" id="modalAdDelete" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-footer">
                    <button class="btn ripple btn-secondary" data-bs-dismiss="modal"
                        type="button">{{ __('Close') }}</button>
                    <button type="submit" class="btn btn-danger" id="deleteAd">{{ __('Delete') }}</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="row row-xs wd-xl-80p">
                        <div class="col-sm-6 col-md-3 mg-t-10">
                            <button class="btn btn-info-gradient btn-block" id="ShowModalAd"
                ...
                <div class="card-body">
                    <div class="table-responsive hoverable-table">
                        <table class="table table-hover" id="get_ad" style=" text-align: center;">
                            <thead>
                                <tr>
                                    <th class="border-bottom-0">#</th>
                                    <th class="border-bottom-0">{{ __('Image') }}</th>
                                    <th class="border-bottom-0">{{ __('Url') }}</th>
...
@section('script')
    ...
    <script src="{{ asset('dashboard/local/ad.js') }}"></script>
@stop
