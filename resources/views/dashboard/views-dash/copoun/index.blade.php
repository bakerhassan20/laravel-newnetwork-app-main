...
@section('content')
                ...
                <div class="modal-body">
                    ...
                    <form id="formCopounAdd" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success" id="addCopoun">{{ __('Save') }}</button>
    ...
    <!-- End Basic modal -->
    <div class="modal" id="modalCopounUpdate">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <form id="formCopounUpdate" enctype="multipart/form-data">
                        @method('PUT')
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success"
                                id="updateCopoun">{{ __('Update') }}</button>
    ...
    <div class="modal" id="modalCopounDelete" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-footer">
                    <button class="btn ripple btn-secondary" data-bs-dismiss="modal"
                        type="button">{{ __('Close') }}</button>
                    <button type="submit" class="btn btn-danger" id="deleteCopoun">{{ __('Delete') }}</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="row row-xs wd-xl-80p">
                        <div class="col-sm-6 col-md-3 mg-t-10">
                            <button class="btn btn-info-gradient btn-block" id="ShowModalCopoun"
                ...
                <div class="card-body">
                    <div class="table-responsive hoverable-table">
                        <table class="table table-hover" id="get_copoun" style=" text-align: center;">
                            <thead>
                                <tr>
...
@section('script')
    ...
    <script src="{{ asset('dashboard/local/copoun.js') }}"></script>
@stop
