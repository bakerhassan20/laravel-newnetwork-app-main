...
@section('content')
    ...
    <div class="modal" id="modalDenouncementDelete" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-danger" id="deleteDenouncement">{{ __('Delete') }}</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card mg-b-20">
                <div class="card-body">
                    <div class="table-responsive hoverable-table">
                        <table class="table table-hover" id="get_denouncement" style=" text-align: center;">
                            <thead>
                                <tr>
                                    <th class="border-bottom-0">#</th>
                                    <th class="border-bottom-0">{{ __('Reason') }}</th>
...
@section('script')
    ...
    <script src="{{ asset('dashboard/local/denouncement.js') }}"></script>
@stop
